...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('simplerating_core_path', null,
                    $modx->getOption('core_path') . 'components/simplerating/') . 'model/';
            $modx->addPackage('simplerating', $modelPath);

            $manager = $modx->getManager();
            $objects = array('SimpleRating');
            $schemaFile = MODX_CORE_PATH . 'components/simplerating/model/schema/simplerating.mysql.schema.xml';
